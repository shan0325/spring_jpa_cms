...
-- 테스트 메뉴 등록
INSERT INTO MENU (MENU_ID, CREATED_DATE, LAST_MODIFIED_DATE, CREATE_BY, LAST_MODIFIED_BY, DESCRIPTION, LEVEL, MENU_TYPE, NAME, ORD, USE_YN, PARENT_ID, TOP_ID) VALUES (1, NOW(), NOW(), 'admin@naver.com', 'admin@naver.com', '서울소식', 0, 'MENU', '서울소식', 1, 'Y', null, null);
